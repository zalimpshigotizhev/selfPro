...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('users', '0002_alter_user_phone_alter_user_token_customuser'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='token',
            field=models.CharField(default=uuid.UUID('b677e8e5-9d33-4770-b559-8858c961c9f0'), max_length=255, unique=True, verbose_name='Токен пользователя'),
        ),
